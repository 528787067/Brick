...
public class OkHttp3GsonRequestConverter<T> extends GsonRequestConverter<T, RequestBody> {

    private static final MediaType MEDIA_TYPE = MediaType.parse("application/json; charset=UTF-8");

    public OkHttp3GsonRequestConverter() {
        this(new Gson());
    }

    public OkHttp3GsonRequestConverter(@NonNull Gson gson) {
