...
public class FileThreadExecutorFactory<T> implements ExecutorFactory<HttpRequest, HttpResponse, T> {
    ...
    public Executor<HttpRequest, HttpResponse, T> create(@NonNull TaskModel<HttpRequest, HttpResponse> taskModel) {
        return new FileThreadExecutor<>(host, directoryMapper, mediaType);
    }

    public static class Builder {

        private FileThreadExecutorFactory executorFactory;

        public Builder() {
            executorFactory = new FileThreadExecutorFactory();
        }

        public FileThreadExecutorFactory.Builder setHost(String host) {
            executorFactory.setHost(host);
            return this;
        }

        public FileThreadExecutorFactory.Builder setHost(File host) {
            executorFactory.setHost(host);
            return this;
        }

        public FileThreadExecutorFactory.Builder setDirectoryMapper(String directoryMapper) {
            executorFactory.setDirectoryMapper(directoryMapper);
            return this;
        }

        public FileThreadExecutorFactory.Builder setMediaType(String mediaType) {
            executorFactory.setMediaType(mediaType);
            return this;
        }

        public FileThreadExecutorFactory.Builder setMediaType(MediaType mediaType) {
            executorFactory.setMediaType(mediaType);
            return this;
        }

        public FileThreadExecutorFactory build() {
