...
public class RxJavaTaskArbiter<T> extends AtomicInteger implements Subscription, Producer {
    ...
    RxJavaTaskArbiter(Task<? extends Request, ? extends Response, T> task, Subscriber<? super T> subscriber) {
        super(STATE_WAITING);
        this.task = task;
