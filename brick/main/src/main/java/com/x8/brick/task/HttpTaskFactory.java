...
public class HttpTaskFactory<REQUEST extends Request, RESPONSE extends Response, RESULT>
        implements TaskFactory<REQUEST, RESPONSE, RESULT> {

    @NonNull
    @Override
    public Task<REQUEST, RESPONSE, RESULT> create(@NonNull TaskModel<REQUEST, RESPONSE> taskModel) {
